...
echo "| by Ray.H                        │"
echo "└─────────────────────────────────┘"
echo "https://github.com/rayhon/claude-code-mastery"
echo ""
echo ""
...
if git rev-parse --git-dir > /dev/null 2>&1; then
  ...
  if git remote -v | grep -q origin; then
    ...
    if [[ "$remote_url" == *"rayhon/claude-code-mastery"* ]] || [[ "$remote_url" == *"rayhon/claude-code-mastery.git"* ]]; then
      echo ""
      echo "  ⚠️ WARNING: Your remote origin points to the claude code mastery template repository!"
